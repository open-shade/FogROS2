...
// Refer to https://docs.ros.org/en/foxy/Tutorials/Writing-A-Simple-Cpp-Publisher-And-Subscriber.html
...
namespace mpt_ros {
    ...
    public:       
        MPTNode()
            : Node("mpt_ros"), planThread_(&MPTNode::plannerLoop, this)
        {
            envMeshSub_ = this->create_subscription<std_msgs::msg::UInt8MultiArray>(
                "environment_mesh", 1000, std::bind(&MPTNode::environmentMeshCallback, this, _1));
            robotMeshSub_ = this->create_subscription<std_msgs::msg::UInt8MultiArray>(
                "robot_mesh", 1000, std::bind(&MPTNode::robotMeshCallback, this, _1));
            boundsSub_ = this->create_subscription<std_msgs::msg::Float64MultiArray>(
                "environment_bounds", 1000, std::bind(&MPTNode::environmentBoundsCallback, this, _1));
            planStartToGoalSub_ = this->create_subscription<std_msgs::msg::Float64MultiArray>(
                "plan_start_to_goal", 1000, std::bind(&MPTNode::planStartToGoalCallback, this, _1));
            motionPlanRequestSub_ = this->create_subscription<mpt_ros::msg::MotionPlanRequest>(
                "motion_plan_request", 1000, std::bind(&MPTNode::motionPlanRequestCallback, this, _1));
